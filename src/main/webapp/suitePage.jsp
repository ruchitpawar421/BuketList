	...
	<section>
			...
			<div class="leftpanelinner">
				...
				<ul class="nav nav-pills nav-stacked nav-bracket">
					...
					<li class="nav-parent"><a href=""><i class="fa fa-tags"></i>
						...
						<ul class="children">
							<li><a href="<%=url %>"><i class="fa fa-road"></i> Run</a></li>

							<li><a href="<%=reportUrl+suite_name%>.html"><i
		...
		<div class="mainpanel">
			...
			<div class="pageheader">
				...
				<div class="breadcrumb-wrapper">
					<input type="text" id="Project"
						...
						style="display: none"> <input type="text" id="Suite"
						value="<%=request.getParameter("suite")%>" style="display: none">
					<a id="PlaySuite" class="breadcrumb"
						href="projectSetupControl?suite=<%=request.getParameter("suite")%>&project=<%=request.getParameter("projectName")%>">
						Start </a> &emsp;<a class="breadcrumb" href=""> Stop </a>
				</div>
			</div>
			...
			<div class="contentpanel">
				...
				<div class="row">
					<%						
							ArrayList<String> tests = listTest.get(request
									.getParameter("suite"));
							String[] test_name;
							for (String test : tests) {
								test_name = test.split("\\.");
								//System.out.println(test_name[test_name.length-1]);
						...
						<div class="panel panel-info panel-stat">
							<div class="panel-heading">
								<div class="panel-btns">
									<a class="" href="">Stop</a> <a id="PlayTest" class=""
										href="projectSetupControl?test=<%=test%>&project=<%=request.getParameter("projectName")%>">Start</a>
								</div>
								<div class="stat">
									<div class="mb15"></div>
									<div class="row">
										<div class="col-xs-6">
											<h5><%=test_name[test_name.length-1] %></h5>
										</div>
									</div>
									<!-- row -->
								</div>
